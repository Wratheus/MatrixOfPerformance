...
class GroupDropDownMenu extends StatefulWidget {
  ...
  GroupDropDownMenu({Key? key, required this.tableController, required this.isExpanded, this.backgroundColor}) : super(key: key);
  @override
        ...
        if ((state as UserDataLoadedState).values.isEmpty == false) {
          ...
          return DecoratedBox(
            decoration: BoxDecoration(
              color: widget.backgroundColor?? MyColors.mainOuterColor,
            ...
            child: Padding(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  focusColor: widget.backgroundColor?? MyColors.mainOuterColor,
                  iconDisabledColor: widget.backgroundColor?? MyColors.mainOuterColor,
                  iconEnabledColor: widget.backgroundColor?? MyColors.mainOuterColor,
