            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                    onPressed: ()=>{
                      (managementTabDropDownMenu.selectedValue != null && (state as MainManagementPageLoadedState).tableData.isNotEmpty) ?
                      AppUI.showMaterialModalDialog(context: context, child: EditRowDialog(context: context, tableValues: state.tableData, tableName: managementTabDropDownMenu.selectedValue))
                          :
                      AppUI.showMaterialModalDialog(context: context, child: SampleErrorDialog(errorMessage: 'No table selected.'))
                    },
